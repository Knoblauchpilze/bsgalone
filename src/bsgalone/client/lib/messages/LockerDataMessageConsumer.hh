...
class LockerDataMessageConsumer : public core::IMessageListener
{
  public:
  LockerDataMessageConsumer(IDataStoreShPtr store, IUiEventQueueShPtr queue);
  ~LockerDataMessageConsumer() override = default;
