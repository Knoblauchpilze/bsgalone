...
class LockerService : public AbstractService
{
  ...
  private:
  bool verifySlotAvailability(const Uuid shipDbId, const bsgalone::core::Item &type) const;
  bool verifyItemBelongsToPlayer(const Uuid playerDbId,
                                 const Uuid itemId,
                                 const bsgalone::core::Item &type) const;
  bool verifyItemIsEquiped(const Uuid shipDbId,
                           const Uuid itemId,
                           const bsgalone::core::Item &type) const;
  bool verifyItemIsNotEquiped(const Uuid itemId, const bsgalone::core::Item &type) const;
