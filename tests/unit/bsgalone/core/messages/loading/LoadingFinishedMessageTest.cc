...
TEST(Unit_Bsgalone_Core_Messages_LoadingFinishedMessage, NoSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingFinishedMessage, WithSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingFinishedMessage, OverridesSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingFinishedMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingFinishedMessage, CloneWithoutSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingFinishedMessage, CloneWithSystem)
{
