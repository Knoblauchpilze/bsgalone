...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, DifferentWhenDbIdIsDifferent)
{
  PlayerShipData data1{.dbId     = Uuid{1234},
                       .position = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                       .radius   = 5.0f,
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, WithSlots)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .shipId         = Uuid{325},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, WithJumpSystem)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                       .radius         = 5.0f,
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, WithAiTargets)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .shipId         = Uuid{325},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, WithReachedTarget)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .shipId         = Uuid{325},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, WithWeapons)
{
  PlayerShipData input{.dbId             = Uuid{1234},
                       .position         = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                       .radius           = 5.0f,
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, ClearsWeapons)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                       .radius         = 5.0f,
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, WithComputers)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                       .radius         = 5.0f,
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipData, ClearsComputers)
{
  PlayerShipData input{.dbId           = Uuid{1234},
                       .position       = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                       .radius         = 5.0f,
