...
TEST(Unit_Bsgalone_Core_Messages_ResourceListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_ResourceListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_ResourceListMessage, Clone)
{
