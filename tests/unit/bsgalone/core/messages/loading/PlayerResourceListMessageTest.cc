...
TEST(Unit_Bsgalone_Core_Messages_PlayerResourceListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerResourceListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerResourceListMessage, Clone)
{
  const std::vector<PlayerResourceData>
  ...
  ASSERT_EQ(cloned->type(), bsgalone::core::MessageType::PLAYER_RESOURCE_LIST);
