...
TEST(Unit_Bsgalone_Core_Messages_PlayerListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerListMessage, OverrideExistingValues)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerListMessage, Clone)
{
