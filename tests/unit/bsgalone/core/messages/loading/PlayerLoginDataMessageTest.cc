...
TEST(Unit_Bsgalone_Core_Messages_PlayerLoginDataMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerLoginDataMessage, WithClientId)
{
  PlayerLoginDataMessage expected;
...
TEST(Unit_Bsgalone_Core_Messages_PlayerLoginDataMessage, Clone)
{
  PlayerLoginDataMessage expected;
  expected.setFaction(Faction::CYLON);
