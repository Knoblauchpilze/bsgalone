...
TEST(Unit_Bsgalone_Core_Messages_LoadingStartedMessage, NoSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingStartedMessage, WithSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingStartedMessage, OverridesSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingStartedMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingStartedMessage, CloneWithoutSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_LoadingStartedMessage, CloneWithSystem)
{
