...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, NoSystemAndNoPlayer)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, OnlySystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, OnlyPlayer)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, SystemAndPlayer)
{
  std::vector<PlayerShipData> shipsData{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, WithClientId)
{
  std::vector<PlayerShipData> shipsData{{
    .dbId       = Uuid{65},
    .position   = Eigen::Vector3f(1.0f, 2.8f, 3.9f),
  ...
  shipsData = {{.dbId = Uuid{17}, .powerPoints = 100.0f, .jumpSystem = Uuid{45}},
               {.dbId       = Uuid{18},
                .radius     = 26.1,
                .playerDbId = Uuid{456},
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, CloneWithSystem)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, CloneWithPlayer)
{
  const std::vector<PlayerShipData> shipsData{
    {.dbId = Uuid{23}, .position = Eigen::Vector3f(1.0f, 2.8f, 3.9f)},
  };
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, WithWeapon)
{
  ...
  std::vector<PlayerShipData> shipsData{
    {.dbId             = Uuid{65},
     ...
     .slots            = {{bsgalone::core::Slot::WEAPON, 3}, {bsgalone::core::Slot::COMPUTER, 2}},
     .weapons          = weapons}};
  ...
  shipsData = {{.dbId        = Uuid{17},
                .powerPoints = 100.0f,
                .slots       = {{bsgalone::core::Slot::COMPUTER, 1}}},
               {.dbId       = Uuid{18},
                .radius     = 26.1,
                .playerDbId = Uuid{456},
                .slots      = {{bsgalone::core::Slot::WEAPON, 3}}}};
  PlayerShipListMessage actual(std::vector<PlayerShipData>{});
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, WithComputer)
{
  std::vector<PlayerComputerData> computers{
    ...
    {.dbId      = Uuid{2},
     .powerCost = 14.2f,
     .allowedTargets
     = std::unordered_set<bsgalone::core::EntityKind>{bsgalone::core::EntityKind::PLAYER},
  ...
  shipsData = {{.dbId = Uuid{17}, .powerPoints = 100.0f},
...
TEST(Unit_Bsgalone_Core_Messages_PlayerShipListMessage, MultipleComplexShips)
{
  std::vector<PlayerShipData> shipsData{
    {.dbId       = Uuid{65},
     .position   = Eigen::Vector3f(1.0f, 2.8f, 3.9f),
    ...
    {.dbId             = Uuid{68},
     ...
     .computers = {{.dbId           = Uuid{1},
                    ...
                    .allowedTargets = std::unordered_set<
                      bsgalone::core::EntityKind>{bsgalone::core::EntityKind::SHIP,
                                                  bsgalone::core::EntityKind::OUTPOST}}}},
    {.dbId          = Uuid{14},
     .position      = Eigen::Vector3f(-1.0f, -98631.8075f, -37.91f),
     .slots         = {{bsgalone::core::Slot::COMPUTER, 4}},
     .reachedTarget = {14},
  ...
  shipsData = {{
               ...
               {.dbId    = Uuid{7415},
                .shipId  = Uuid{134},
                .slots   = {{bsgalone::core::Slot::COMPUTER, 7}, {bsgalone::core::Slot::WEAPON, 3}},
