...
TEST(Unit_Bsgalone_Core_Messages_WeaponListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_WeaponListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_WeaponListMessage, Clone)
{
  ...
  ASSERT_EQ(cloned->type(), MessageType::WEAPON_LIST);
