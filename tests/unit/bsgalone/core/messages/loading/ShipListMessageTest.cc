...
TEST(Unit_Bsgalone_Core_Messages_ShipListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_ShipListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_ShipListMessage, Clone)
{
...
TEST(Unit_Bsgalone_Core_Messages_ShipListMessage, MultipleComplexShips)
{
