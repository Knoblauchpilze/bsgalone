...
TEST(Unit_Bsgalone_Core_Messages_OutpostListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_OutpostListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_OutpostListMessage, Clone)
{
