...
TEST(Unit_Bsgalone_Core_Messages_ComputerData, DifferentWhenDbIdIsDifferent)
{
...
TEST(Unit_Bsgalone_Core_Messages_ComputerData, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_ComputerData, NonEmptyAllowedTargetsInDestination)
{
  ComputerData input{.dbId           = Uuid{1234},
                     .name           = "a computer",
                     .range          = 98765.1234f,
...
TEST(Unit_Bsgalone_Core_Messages_ComputerData, NonEmptyDamageModifierInDestination)
{
