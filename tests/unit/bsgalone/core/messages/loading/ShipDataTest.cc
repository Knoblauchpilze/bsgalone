...
TEST(Unit_Bsgalone_Core_Messages_ShipData, DifferentWhenDbIdIsDifferent)
{
  ShipData data1{.dbId      = Uuid{1234},
...
TEST(Unit_Bsgalone_Core_Messages_ShipData, Basic)
{
  ShipData input{
    .dbId            = Uuid{1234},
    .name            = "my-ship",
...
TEST(Unit_Bsgalone_Core_Messages_ShipData, WithSlots)
{
...
TEST(Unit_Bsgalone_Core_Messages_ShipData, WithPrice)
{
  ShipData input{.dbId           = Uuid{1234},
                 .maxPowerPoints = 100.0f,
                 .acceleration   = 2.5f,
