...
TEST(Unit_Bsgalone_Core_Messages_WeaponData, EqualWhenDbIdIsEqual)
{
...
TEST(Unit_Bsgalone_Core_Messages_WeaponData, DifferentWhenDbIdIsDifferent)
{
...
TEST(Unit_Bsgalone_Core_Messages_WeaponData, Basic)
{
