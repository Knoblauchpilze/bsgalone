...
TEST(Unit_Bsgalone_Core_Messages_AsteroidListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_AsteroidListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_AsteroidListMessage, Clone)
{
  const std::vector<AsteroidData> asteroidsData{
  ...
  ASSERT_EQ(cloned->type(), bsgalone::core::MessageType::ASTEROID_LIST);
