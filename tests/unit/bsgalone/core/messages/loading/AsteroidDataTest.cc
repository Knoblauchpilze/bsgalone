...
TEST(Unit_Bsgalone_Core_Messages_AsteroidData, DifferentWhenDbIdIsDifferent)
{
  AsteroidData data1{.dbId     = Uuid{1234},
                     .position = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                     .radius   = 5.0f,
...
TEST(Unit_Bsgalone_Core_Messages_AsteroidData, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_AsteroidData, WithLoot)
{
  AsteroidData input{.dbId      = Uuid{1234},
                     .position  = Eigen::Vector3f{1.0f, 2.0f, 3.0f},
                     .radius    = 5.0f,
