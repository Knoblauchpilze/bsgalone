...
TEST(Unit_Bsgalone_Core_Messages_PlayerResourceData, DifferentWhenDbIdIsDifferent)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerResourceData, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerResourceData, EmptyOutputName)
{
