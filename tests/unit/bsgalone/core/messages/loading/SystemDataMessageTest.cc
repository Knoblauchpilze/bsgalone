...
TEST(Unit_Bsgalone_Core_Messages_SystemDataMessage, Basic)
{
  SystemTickData data{
    .dbId        = Uuid{12},
...
TEST(Unit_Bsgalone_Core_Messages_SystemDataMessage, WithClientId)
{
  SystemTickData data{
    .dbId        = Uuid{85},
...
TEST(Unit_Bsgalone_Core_Messages_SystemDataMessage, Clone)
{
  SystemTickData data{
    .dbId        = Uuid{85},
    .currentTick = chrono::Tick(12.04508f),
