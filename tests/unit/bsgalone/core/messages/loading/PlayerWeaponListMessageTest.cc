...
TEST(Unit_Bsgalone_Core_Messages_PlayerWeaponListMessage, Basic)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerWeaponListMessage, WithClientId)
{
...
TEST(Unit_Bsgalone_Core_Messages_PlayerWeaponListMessage, Clone)
{
  const std::vector<PlayerWeaponData> weaponsData{
