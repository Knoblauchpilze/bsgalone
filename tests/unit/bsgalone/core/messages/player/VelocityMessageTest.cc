...
{
  const VelocityMessage expected(bsgo::Uuid{21}, Eigen::Vector3f(-3.45f, 37.26f, -0.145f));
  VelocityMessage actual(bsgo::Uuid{36}, Eigen::Vector3f(-23.104f, -1089.784f, 4.897f));
