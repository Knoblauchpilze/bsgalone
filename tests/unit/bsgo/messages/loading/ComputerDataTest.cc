...
TEST(Unit_Bsgo_Serialization_ComputerData, Basic)
{
  ...
  ComputerData output{.dbId = Uuid{14}, .powerCost = 26.57f, .reloadTime = Tick::fromInt(1234)};
...
TEST(Unit_Bsgo_Serialization_ComputerData, AllowedTargets)
{
  ...
  ComputerData output{.dbId = Uuid{14}, .name = "beefy computer", .reloadTime = Tick(1234, 0.0f)};
